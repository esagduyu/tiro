...
[x] 22. UX redesign (themes, sidebar, filter panel)
[x] 23. Digest scheduling & history
-->
...
**Last full test run:** 2026-02-15 — Checkpoints 1–13. Checkpoints 14–23 verified incrementally as added. See `docs/PLAYWRIGHT_TEST_NOTES.md` for detailed results.
